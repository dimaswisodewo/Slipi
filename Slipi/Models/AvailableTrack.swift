...
extension AvailableTrack {
    ...
    static let beads = AvailableTrack(name: "Beads", fileName: "beads", iconName: "circle.hexagongrid")
    static let bedSheets = AvailableTrack(name: "Bed Sheets", fileName: "bed-sheets", iconName: "bed.double")
    static let boilingWater = AvailableTrack(name: "Boiling Water", fileName: "boiling-water", iconName: "drop.degreesign")
    static let bookPageTurning = AvailableTrack(name: "Book Page Turning", fileName: "book-page-turning", iconName: "book.pages")
    static let bubbleWrap = AvailableTrack(name: "Bubble Wrap", fileName: "bubble-wrap", iconName: "circle.grid.3x3")
    ...
    static let fizzyDrink = AvailableTrack(name: "Fizzy Drink", fileName: "fizzy-drink", iconName: "bubbles.and.sparkles")
    ...
    static let iceCubes = AvailableTrack(name: "Ice Cubes", fileName: "ice-cubes", iconName: "cube")
    static let makeupBrush = AvailableTrack(name: "Makeup Brush", fileName: "makeup-brush", iconName: "paintbrush")
    static let micScratching = AvailableTrack(name: "Mic Scratching", fileName: "mic-scratching", iconName: "mic")
    static let scrapingWood = AvailableTrack(name: "Scraping Wood", fileName: "scraping-wood", iconName: "tree.fill")
    static let slime = AvailableTrack(name: "Slime", fileName: "slime", iconName: "drop.fill")
    static let tapWater = AvailableTrack(name: "Tap Water", fileName: "tap-water", iconName: "water.waves")
    static let tinFoil = AvailableTrack(name: "Tin Foil", fileName: "tin-foil", iconName: "square.stack.3d.down.right")
    static let vinylCrackle = AvailableTrack(name: "Vinyl Crackle", fileName: "vinyl-crackle", iconName: "record.circle")
    static let walkingOnSnow = AvailableTrack(name: "Walking On Snow", fileName: "walking-on-snow", iconName: "shoeprints.fill")
    static let waterSlushing = AvailableTrack(name: "Water Slushing", fileName: "water-slushing", iconName: "drop.circle")
    static let waterFlowing = AvailableTrack(name: "Water Flowing", fileName: "water-flowing", iconName: "drop.circle")
    static let windInEars = AvailableTrack(name: "Wind In Ears", fileName: "wind-in-ears", iconName: "wind")
    ...
    static let catPurring2 = AvailableTrack(name: "Cat Purring 2", fileName: "cat-purring 2", iconName: "cat")
    static let crickets2 = AvailableTrack(name: "Crickets 2", fileName: "Crickets", iconName: "ladybug")
    ...
    static let catalog: [AvailableTrack] = [
        ...
        walkingOnSnow, waterFlowing, waterSlushing, whale, windBlowing, windInEars,
        windTrees, winterForest, walkingOnDryLeaves, writing, winter, wolfHowls,
        catPurring2, crickets2
    ]
